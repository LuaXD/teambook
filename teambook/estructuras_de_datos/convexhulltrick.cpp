...
/***
=============== <Convex hull trick normal version> ===================
Contain a sample about convex hull trick optimization this recivie N pairs:
a "value of length" and a cost, we need to minimize the value of grouping 
this pairs taken the most large pair as the cost of the group
